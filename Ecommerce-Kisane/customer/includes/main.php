      ...
      <div class="container clearfix">
        ...
        <div class="logo">
          <a class="logo__link" href="../index.php">
            <img class="logo__img" src="images/logo.png" alt="Kisane logotype" width="237" height="19">
          </a>
        </div>
              ...
              <div class="dropdown dropdown--lookbook">
                <div class="clearfix">
                  <div class="dropdown__half">
                    <div class="dropdown__heading">Opciones de Cuenta</div>
                    <ul class="dropdown__items">
                      <li class="dropdown__item">
                        <a href="#" class="dropdown__link">Mi Wishlist</a>
                      </li>
                      <li class="dropdown__item">
